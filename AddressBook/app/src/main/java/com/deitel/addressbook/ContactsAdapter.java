/*
* ContactsAdapter (Section 9.11)—This subclass of RecyclerView.Adapter is used
* by ContactsFragment’s RecyclerView to bind the sorted list of contact names
*  to the RecyclerView.
*  RecyclerView.Adapter was introduced in Sections 8.3.4 and 8.6,
* so we discuss only the database-specific operations in this class.
* */
...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder>
{
    ...
    private final ContactClickListener clickListener; // how is this still "final"? :O
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        // set the database rowID for the contact in this ViewHolder
        public void setRowID(long rowID)
        {
            this.rowID = rowID;
        }
    }/*end ViewHolder nested class*/
