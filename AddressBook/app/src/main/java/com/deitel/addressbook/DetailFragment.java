/*
* DetailFragment (Section 9.13)—This class manages the styled TextViews that
* display a selected contact’s details and the app bar items that enable the user to
*  edit or delete the currently displayed contact.
* DetailFragment’s nested interface defines callback methods implemented by MainActivity
*  so that it can respond when a contact is deleted or when the user touches
*  the app bar item to edit a contact.
*/
...
public class DetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    {   // NOTE THAT THIS EVENT LISTENER IS CARRIED BY THE INHERITED/OVERRIDDEN METHODS !!
        ...
        (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        // get Bundle arguments then extract the contact's Uri
        Bundle arguments = getArguments();

        if (arguments != null) { contactUri = arguments.getParcelable(MainActivity.CONTACT_URI); }
    ...
    {   // create an AlertDialog and return it
        ...
        {   // create a new AlertDialog Builder
            ...
            (
                R.string.button_delete, new DialogInterface.OnClickListener()
                {
                    @Override
                    public void onClick(DialogInterface dialog, int button)
                    {   // use Activity's ContentResolver to invoe
            ...
            ); /*end builder.setPositiveButton function call*/
            //----------------------------------------------------------
        ...
        switch (id)
        {
            case CONTACT_LOADER:
                cursorLoader = new androidx.loader.content.CursorLoader
                        (getActivity(), contactUri, // contact to display
