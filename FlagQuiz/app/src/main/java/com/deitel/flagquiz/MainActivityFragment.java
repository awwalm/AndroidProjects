...
public class MainActivityFragment extends Fragment
{
    ...
    private List<String> fileNameList; // flag file (images) names
    ...
    public void resetQuiz()
    {
        ...
        while (flagCounter <= FLAGS_IN_QUIZ)
        {
            ...
            // if the question is enabled and it hasn't already been chosen
        ...
        loadNextFlag(); // start the quiz by loading next flag
    ...
    {   // get file name of the next flag and remove it from the list
        ...
        questionNumberTextView.setText( getString(R.string.question, (correctAnswers + 1),
                                                  FLAGS_IN_QUIZ) );
        ...
        // get and InputStream to the asset representing the next flag
        ...
        // add 2, 4, 6, or 8 guess Buttons based on the value of the guessRows
        for (int row = 0; row < guessRows; row++)
        {
        ...
        // randomly replace name and set it as newGuessButton's text
    ...
    private OnClickListener guessButtonListener = new OnClickListener()
    {
        ...
        public void onClick(View v)
        {
                ...
                {   // Dialog fragment to display quiz stats and start new quiz
                    DialogFragment quizResults = new DialogFragment()
                    {
                        ...
                        public Dialog onCreateDialog(Bundle bundle)
                        {
                            ...
                            (
                                R.string.reset_quiz, new DialogInterface.OnClickListener()
                                {
                    ...
                    }; // AlertDialog inner class

                    // use FragmentManager to display the DialogFragment
                    quizResults.setCancelable(false);
                    quizResults.show(getFragmentManager(), "quiz_results");
                } // end if, begin else
                else
            ...
            } // MASTER IF-BLOCK FOR CORRECT ANSWER
            else
            {   // answer was incorrect
                flagImageView.startAnimation(shakeAnimation); // lay shake animation
...
} /*end MainActivityFragment class*/
